...
interface MoneyEarningStepProps {
  onNext: (answer: string) => void;
}

const MoneyEarningStep: React.FC<MoneyEarningStepProps> = ({ onNext }) => {
  const { t, language } = useSurvey();
  
  const answers = [
    {
      value: "Yes, Successfully",
      title: t.yesSuccessfully
    },
    {
      value: "Mixed Results",
      title: t.mixedResults
    },
    {
      value: "No, Interested",
      title: t.noInterested
    },
    {
      value: "No Experience",
...
export default MoneyEarningStep;